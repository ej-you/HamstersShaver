...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/transactions.TransactionInfoWithStatusOK"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "transactions.TransactionInfoWithStatusOK": {
            "type": "object",
            "properties": {
                "action": {
                    "description": "действие с монетами в транзакции (покупка/продажа)",
                ...
                "bounce": {
                    "description": "была ли отклонена транзакция (не означает успех или неудачу транзакции)",
                    "type": "boolean",
                    "example": true
                },
                "endBalance": {
